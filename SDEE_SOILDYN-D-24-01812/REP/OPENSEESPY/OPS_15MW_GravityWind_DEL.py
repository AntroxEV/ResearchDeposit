...
def modelWind(xdamp,target,tmax,caseW):
    ...
    np.savetxt('uTOP' + caseW + '_DEL.txt',uTOP)
    np.savetxt('aTOP'+ caseW + '_DEL.txt',aTOP)
    np.savetxt('time'+ caseW + '_DEL.txt',Atime)
    np.savetxt('MYmud'+ caseW + '_DEL.txt',MYmud)
    #np.savetxt('uTOP' + caseW + '_DELVER.txt',uTOP)
    #np.savetxt('aTOP'+ caseW + '_DELVER.txt',aTOP)
    #np.savetxt('time'+ caseW + '_DELVER.txt',Atime)
    #np.savetxt('MYmud'+ caseW + '_DELVER.txt',MYmud)
