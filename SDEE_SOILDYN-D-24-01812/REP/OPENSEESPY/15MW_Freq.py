...
# nodal coordinates:
for i in range(0,89):
    element('twoNodeLink', 111+i, 113+i, 24+i, '-mat', 89-i, 179-i, '-dir', 1,3)
# RIGHT SIDE START FROM NODE 203
for i in range(0,89):
    element('twoNodeLink', 201+i, 203+i, 24+i, '-mat', 89-i, 179-i, '-dir', 1,3)
